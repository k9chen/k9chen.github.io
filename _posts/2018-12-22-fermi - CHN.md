...
当然，德雷克方程也有其自身的缺陷，比方说它难以估计某些参数（例如$$ f_i $$、$$ f_c $$和$$ L $$），并且依赖于大量的数值假设，因此会产生乐观或悲观的结果；作为证明，牛津大学的一组科研团队声称我们在宇宙中独自生存的概率为[39%--85%](https://arxiv.org/abs/1806.02404)。虽然看似令人沮丧，但它足以让我们有一定程度的信心，相信与外星人接触的可能性确实存在，无论最终计算出来的$$ N $$有多小，尤其是考虑到在该模型和其他类似于德雷克方程的原始数学公式中，我们银河系规模以上的一切都被忽略了。我们只能通过连接所有存在的点才能开始想象宇宙视界之外更大的图景；我们不应该孤独地存在。
