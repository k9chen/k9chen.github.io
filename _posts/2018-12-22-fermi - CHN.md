...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/dark.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    宇宙看上去就像一座狼多肉少的黑暗森林。图片由<a href="https://unsplash.com/@karsten_wuerth">卡斯滕·沃尔特</a>在<a href="https://unsplash.com/photos/flowing-river-between-tall-trees-7BjhtdogU3A">Unsplash</a>上所提供。  
</div>
