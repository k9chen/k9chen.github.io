...
一个与大过滤器理论密切相关的解决方案是通过[超线性缩放](https://royalsocietypublishing.org/doi/10.1098/rsif.2022.0029)来解释的。根据这个假设，一个文明将不可避免地接近一个奇异点，其中人口和能源需求在有限的时间内导致无限增长，从而引起一种渐近倦怠，使一个文明的生产力和资源消耗呈超线性缩放而导致该文明的衰落。这种增长可以通过以下一阶[常微分方程](https://www.pnas.org/doi/10.1073/pnas.0610172104)进行建模：
...
<div class="caption">
    在非贝叶斯条件下的完全信息顺序博弈中，此决策树展示了两个文明各自的收益情况。
</div>
...
<div class="caption">
    在非贝叶斯条件下的不完全信息顺序博弈中，决策树展示了两个文明各自的收益情况。
</div>
