...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/deci.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Decision tree for subgame perfect Nash equilibrium.
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/decit.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Decision tree for perfect Bayesian equilibrium.
</div>
